...
ZRDAAM(
    ...
    DzEa_sigma::T=1.0           # [kJ/mol] uncertainty 
    ...
    DN17Ea_sigma::T=1.0         # [kJ/mol] uncertainty 
    lint0::T=45920.0            # [nm]
    SV::T=1.669                 # [1/nm]
...
RDAAM(
    ...
    EaL_sigma::T=1.0            # [kJ/mol] uncertainty
    EaTrap::T=34.0              # [kJ/mol] Activation energy
    EaTrap_sigma::T=1.0         # [kJ/mol] uncertainty
...
Base.@kwdef struct RDAAM{T<:AbstractFloat} <: ApatiteHeliumModel{T} 
    ...
    EaL_sigma::T=1.0            # [kJ/mol] uncertainty
    EaTrap::T=34.0              # [kJ/mol] Activation energy
    EaTrap_sigma::T=1.0         # [kJ/mol] uncertainty    psi::T=1e-13                # empirical polynomial coefficient
    psi::T=1e-13                # empirical polynomial coefficient
    omega::T=1e-22              # empirical polynomial coefficient
    etaq::T=0.91                # Durango ηq
    rhoap::T=3.19               # [g/cm3] Density of apatite 
