...
Implements a Markov chain Monte Carlo (MCMC) time-temperature inversion with optional Simulated Annealing (e.g., [Laahoven and Aarts, 1987](https://doi.org/10.1007/978-94-015-7744-1_2)).
