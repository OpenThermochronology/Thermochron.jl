...
## --- Test generation of Chronometer objects
    ...
    @test Thermochron.model!(calc, calcuncert, chrons, damodels, Tsteps) ≈ -3674.2208580266874
    @test Thermochron.model!(calc, calcuncert, chrons, damodels, Tsteps; trackhist=true) ≈ -3675.7197780746797
    @test Thermochron.model!(calc, calcuncert, chrons, damodels, Tsteps; redegasparent=true) ≈ -3607.8248296646084
    ...
    @test Thermochron.model!(calc, calcuncert, chrons, damodels, Tsteps) ≈ -3691.970243126419
    @test Thermochron.model!(calc, calcuncert, chrons, damodels, Tsteps; trackhist=true) ≈ -3693.486549848891
    @test Thermochron.model!(calc, calcuncert, chrons, damodels, Tsteps; redegasparent=true) ≈ -3625.574214764339
