...
## --- Test track lengths
    ...
    modellength(track, fill(75, 20), FCKetcham1999)
    ...
    modellength(track, fill(75, 20), FCKetcham2007)
    ...
    modellength(track, fill(100, 20), FCKetcham1999)
    ...
    modellength(track, reverse(1:20).*5, FCKetcham2007)
    ...
    modellength(track, reverse(1:20).*10, FCKetcham1999)
    ...
    modellength(track, reverse(1:20).*10, FCKetcham2007)
...
## -- Check the mean track length of a modelled Fish Canyon Apatite to be 15.35 +/- 0.06 um
    ...
    track = ApatiteTrackLength(length=15, angle=35, agesteps=reverse(cntr(0:28)), dpar=2.33)
